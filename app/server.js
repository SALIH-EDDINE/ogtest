...
client.login(`NzYzNjA4MzUyNDY1ODc5MDQw.X36Lsg.KvEIsWPQl_6qT0F1KbTUTAXaFMg`)
const queue = new Map();
...
> **Giveaway Commands** <a:give:755109636771938306>
$start | $groll | $gend

> **Music Commands** <a:music:755109623157227602>
$play | $stop | $skip | $pause | $forceskip | $Queue | $skipto | $Volume | $np | $repeat

> **Protection Commands** <:657678974939299853:755109614525218837>
$antibots on/off | $antihack on/off | $antilink on/off

> **Invite Commands** <:647115718600687627:755109600016990209>
$setinv | $invites | $info | $topinvites

> **Ticket Commands** :tickets:
$mtickets | $new | $close | $add | $remove

> **Games Command** <:673312436903739420:755109607600422912>
$Sra7a | $لو خيروك | $Za7f  | $خواطر | $cuttweet | $مريم | $love
...
`
      ...
      .setFooter("Developer <@704816350887018520>");
  ...
  if (message.content.startsWith("$Devs")) {
    message.channel.send({
      embed: new Discord.RichEmbed()
        ...
        .setColor("BLACK")
        .setTitle("``Developer`` ")
        .addField("**Name**", `<@708708508262203502>`, true)
        .addField("**year**", `15`, true)
